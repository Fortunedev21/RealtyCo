...
class __TwigTemplate_d531faac75513f70707a38d21dfccade extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/claro/templates/filter/filter-tips.html.twig", "D:\\Projects\\real estate\\real_estate\\web\\core\\themes\\claro\\templates\\filter\\filter-tips.html.twig");
    }
